 ...
 * Stub hash: df69594e529870d8a7e985d282d4f5ade3e7b37a */
...
static zend_class_entry *register_class_ZMQ(void)
{
	...
	zend_string *const_CTXOPT_BLOCKY_name = zend_string_init_interned("CTXOPT_BLOCKY", sizeof("CTXOPT_BLOCKY") - 1, true);
	zend_declare_class_constant_ex(class_entry, const_CTXOPT_BLOCKY_name, &const_CTXOPT_BLOCKY_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release_ex(const_CTXOPT_BLOCKY_name, true);

	zval const_CTXOPT_IO_THREADS_value;
	ZVAL_LONG(&const_CTXOPT_IO_THREADS_value, ZMQ_IO_THREADS);
	zend_string *const_CTXOPT_IO_THREADS_name = zend_string_init_interned("CTXOPT_IO_THREADS", sizeof("CTXOPT_IO_THREADS") - 1, true);
	zend_declare_class_constant_ex(class_entry, const_CTXOPT_IO_THREADS_name, &const_CTXOPT_IO_THREADS_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release_ex(const_CTXOPT_IO_THREADS_name, true);

	zval const_CTXOPT_THREAD_SCHED_POLICY_value;
	ZVAL_LONG(&const_CTXOPT_THREAD_SCHED_POLICY_value, ZMQ_THREAD_SCHED_POLICY);
	zend_string *const_CTXOPT_THREAD_SCHED_POLICY_name = zend_string_init_interned("CTXOPT_THREAD_SCHED_POLICY", sizeof("CTXOPT_THREAD_SCHED_POLICY") - 1, true);
	zend_declare_class_constant_ex(class_entry, const_CTXOPT_THREAD_SCHED_POLICY_name, &const_CTXOPT_THREAD_SCHED_POLICY_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release_ex(const_CTXOPT_THREAD_SCHED_POLICY_name, true);

	zval const_CTXOPT_THREAD_PRIORITY_value;
	ZVAL_LONG(&const_CTXOPT_THREAD_PRIORITY_value, ZMQ_THREAD_PRIORITY);
	zend_string *const_CTXOPT_THREAD_PRIORITY_name = zend_string_init_interned("CTXOPT_THREAD_PRIORITY", sizeof("CTXOPT_THREAD_PRIORITY") - 1, true);
	zend_declare_class_constant_ex(class_entry, const_CTXOPT_THREAD_PRIORITY_name, &const_CTXOPT_THREAD_PRIORITY_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release_ex(const_CTXOPT_THREAD_PRIORITY_name, true);

	zval const_CTXOPT_THREAD_AFFINITY_CPU_ADD_value;
	ZVAL_LONG(&const_CTXOPT_THREAD_AFFINITY_CPU_ADD_value, ZMQ_THREAD_AFFINITY_CPU_ADD);
	zend_string *const_CTXOPT_THREAD_AFFINITY_CPU_ADD_name = zend_string_init_interned("CTXOPT_THREAD_AFFINITY_CPU_ADD", sizeof("CTXOPT_THREAD_AFFINITY_CPU_ADD") - 1, true);
	zend_declare_class_constant_ex(class_entry, const_CTXOPT_THREAD_AFFINITY_CPU_ADD_name, &const_CTXOPT_THREAD_AFFINITY_CPU_ADD_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release_ex(const_CTXOPT_THREAD_AFFINITY_CPU_ADD_name, true);

	zval const_CTXOPT_THREAD_AFFINITY_CPU_REMOVE_value;
	ZVAL_LONG(&const_CTXOPT_THREAD_AFFINITY_CPU_REMOVE_value, ZMQ_THREAD_AFFINITY_CPU_REMOVE);
	zend_string *const_CTXOPT_THREAD_AFFINITY_CPU_REMOVE_name = zend_string_init_interned("CTXOPT_THREAD_AFFINITY_CPU_REMOVE", sizeof("CTXOPT_THREAD_AFFINITY_CPU_REMOVE") - 1, true);
	zend_declare_class_constant_ex(class_entry, const_CTXOPT_THREAD_AFFINITY_CPU_REMOVE_name, &const_CTXOPT_THREAD_AFFINITY_CPU_REMOVE_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release_ex(const_CTXOPT_THREAD_AFFINITY_CPU_REMOVE_name, true);

	zval const_CTXOPT_THREAD_NAME_PREFIX_value;
	ZVAL_LONG(&const_CTXOPT_THREAD_NAME_PREFIX_value, ZMQ_THREAD_NAME_PREFIX);
	zend_string *const_CTXOPT_THREAD_NAME_PREFIX_name = zend_string_init_interned("CTXOPT_THREAD_NAME_PREFIX", sizeof("CTXOPT_THREAD_NAME_PREFIX") - 1, true);
	zend_declare_class_constant_ex(class_entry, const_CTXOPT_THREAD_NAME_PREFIX_name, &const_CTXOPT_THREAD_NAME_PREFIX_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release_ex(const_CTXOPT_THREAD_NAME_PREFIX_name, true);

	zval const_CTXOPT_MAX_MSGSZ_value;
	ZVAL_LONG(&const_CTXOPT_MAX_MSGSZ_value, ZMQ_MAX_MSGSZ);
	...
	zend_string *const_CTXOPT_ZERO_COPY_RECV_name = zend_string_init_interned("CTXOPT_ZERO_COPY_RECV", sizeof("CTXOPT_ZERO_COPY_RECV") - 1, true);
	...
	ZVAL_LONG(&const_CTXOPT_MAX_SOCKETS_value, ZMQ_MAX_SOCKETS);
