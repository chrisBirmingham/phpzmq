 ...
 * Stub hash: c926189e65e094c351b7dc3e5c9117777e833e1a */
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_ZMQSocket_send, 0, 1, IS_STATIC, 0)
	ZEND_ARG_TYPE_INFO(0, message, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, mode, IS_LONG, 0, "0")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_ZMQSocket_recv, 0, 0, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, mode, IS_LONG, 0, "0")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_ZMQSocket_sendmulti, 0, 1, IS_STATIC, 0)
	ZEND_ARG_TYPE_INFO(0, message, IS_ARRAY, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, mode, IS_LONG, 0, "0")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_ZMQSocket_recvmulti, 0, 0, IS_ARRAY, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, mode, IS_LONG, 0, "0")
ZEND_END_ARG_INFO()
...
static const zend_function_entry class_ZMQSocket_methods[] = {
	...
	ZEND_MALIAS(ZMQSocket, sendmsg, send, arginfo_class_ZMQSocket_sendmsg, ZEND_ACC_PUBLIC)
	ZEND_MALIAS(ZMQSocket, recvmsg, recv, arginfo_class_ZMQSocket_recvmsg, ZEND_ACC_PUBLIC)
	ZEND_FE_END
};
...
static const zend_function_entry class_ZMQException_methods[] = {
	ZEND_FE_END
};


static const zend_function_entry class_ZMQContextException_methods[] = {
	ZEND_FE_END
};


static const zend_function_entry class_ZMQSocketException_methods[] = {
	ZEND_FE_END
};


static const zend_function_entry class_ZMQPollException_methods[] = {
	ZEND_FE_END
};


static const zend_function_entry class_ZMQDeviceException_methods[] = {
	ZEND_FE_END
};
...
static zend_class_entry *register_class_ZMQ(void)
{
	...
	zend_string_release(const_LIBZMQ_VERSION_MAJOR_name);

	zval const_LIBZMQ_VERSION_MINOR_value;
	ZVAL_LONG(&const_LIBZMQ_VERSION_MINOR_value, ZMQ_VERSION_MINOR);
	zend_string *const_LIBZMQ_VERSION_MINOR_name = zend_string_init_interned("LIBZMQ_VERSION_MINOR", sizeof("LIBZMQ_VERSION_MINOR") - 1, 1);
	...
	zend_string_release(const_LIBZMQ_VERSION_MINOR_name);

	zval const_LIBZMQ_VERSION_PATCH_value;
	ZVAL_LONG(&const_LIBZMQ_VERSION_PATCH_value, ZMQ_VERSION_PATCH);
	zend_string *const_LIBZMQ_VERSION_PATCH_name = zend_string_init_interned("LIBZMQ_VERSION_PATCH", sizeof("LIBZMQ_VERSION_PATCH") - 1, 1);
	...
	zend_string_release(const_LIBZMQ_VERSION_PATCH_name);
	...
	zend_string *const_SOCKOPT_ONLY_FIRST_SUBSCRIBE_name = zend_string_init_interned("SOCKOPT_ONLY_FIRST_SUBSCRIBE", sizeof("SOCKOPT_ONLY_FIRST_SUBSCRIBE") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_ONLY_FIRST_SUBSCRIBE_name);
#endif
	...
	zend_string *const_SOCKOPT_WSS_TRUST_SYSTEM_name = zend_string_init_interned("SOCKOPT_WSS_TRUST_SYSTEM", sizeof("SOCKOPT_WSS_TRUST_SYSTEM") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_WSS_TRUST_SYSTEM_name);
#endif
	...
	zend_string *const_SOCKOPT_WSS_HOSTNAME_name = zend_string_init_interned("SOCKOPT_WSS_HOSTNAME", sizeof("SOCKOPT_WSS_HOSTNAME") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_WSS_HOSTNAME_name);
#endif
	...
	zend_string *const_SOCKOPT_WSS_TRUST_PEM_name = zend_string_init_interned("SOCKOPT_WSS_TRUST_PEM", sizeof("SOCKOPT_WSS_TRUST_PEM") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_WSS_TRUST_PEM_name);
#endif
	...
	zend_string *const_SOCKOPT_WSS_CERT_PEM_name = zend_string_init_interned("SOCKOPT_WSS_CERT_PEM", sizeof("SOCKOPT_WSS_CERT_PEM") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_WSS_CERT_PEM_name);
#endif
	...
	zend_string *const_SOCKOPT_WSS_KEY_PEM_name = zend_string_init_interned("SOCKOPT_WSS_KEY_PEM", sizeof("SOCKOPT_WSS_KEY_PEM") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_WSS_KEY_PEM_name);
#endif
	...
	zend_string *const_SOCKOPT_OUT_BATCH_SIZE_name = zend_string_init_interned("SOCKOPT_OUT_BATCH_SIZE", sizeof("SOCKOPT_OUT_BATCH_SIZE") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_OUT_BATCH_SIZE_name);
#endif
	...
	zend_string *const_SOCKOPT_IN_BATCH_SIZE_name = zend_string_init_interned("SOCKOPT_IN_BATCH_SIZE", sizeof("SOCKOPT_IN_BATCH_SIZE") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_IN_BATCH_SIZE_name);
#endif
	...
	zend_string *const_SOCKOPT_SOCKS_PASSWORD_name = zend_string_init_interned("SOCKOPT_SOCKS_PASSWORD", sizeof("SOCKOPT_SOCKS_PASSWORD") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_SOCKS_PASSWORD_name);
#endif
	...
	zend_string *const_SOCKOPT_SOCKS_USERNAME_name = zend_string_init_interned("SOCKOPT_SOCKS_USERNAME", sizeof("SOCKOPT_SOCKS_USERNAME") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_SOCKS_USERNAME_name);
#endif
	...
	zend_string *const_SOCKOPT_XPUB_MANUAL_LAST_VALUE_name = zend_string_init_interned("SOCKOPT_XPUB_MANUAL_LAST_VALUE", sizeof("SOCKOPT_XPUB_MANUAL_LAST_VALUE") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_XPUB_MANUAL_LAST_VALUE_name);
#endif
	...
	zend_string *const_SOCKOPT_ROUTER_NOTIFY_name = zend_string_init_interned("SOCKOPT_ROUTER_NOTIFY", sizeof("SOCKOPT_ROUTER_NOTIFY") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_ROUTER_NOTIFY_name);
#endif
	...
	zend_string *const_SOCKOPT_MULTICAST_LOOP_name = zend_string_init_interned("SOCKOPT_MULTICAST_LOOP", sizeof("SOCKOPT_MULTICAST_LOOP") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_MULTICAST_LOOP_name);
#endif
	...
	zend_string *const_SOCKOPT_METADATA_name = zend_string_init_interned("SOCKOPT_METADATA", sizeof("SOCKOPT_METADATA") - 1, 1);
	zend_declare_class_constant_ex(class_entry, const_SOCKOPT_METADATA_name, &const_SOCKOPT_METADATA_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release(const_SOCKOPT_METADATA_name);
#endif
	...
	zend_string *const_SOCKOPT_LOOPBACK_FASTPATH_name = zend_string_init_interned("SOCKOPT_LOOPBACK_FASTPATH", sizeof("SOCKOPT_LOOPBACK_FASTPATH") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_LOOPBACK_FASTPATH_name);
#endif
	...
	zend_string *const_SOCKOPT_ZAP_ENFORCE_DOMAIN_name = zend_string_init_interned("SOCKOPT_ZAP_ENFORCE_DOMAIN", sizeof("SOCKOPT_ZAP_ENFORCE_DOMAIN") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_ZAP_ENFORCE_DOMAIN_name);
#endif
	...
	zend_string *const_SOCKOPT_GSSAPI_PRINCIPAL_NAMETYPE_name = zend_string_init_interned("SOCKOPT_GSSAPI_PRINCIPAL_NAMETYPE", sizeof("SOCKOPT_GSSAPI_PRINCIPAL_NAMETYPE") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_GSSAPI_PRINCIPAL_NAMETYPE_name);
#endif
	...
	zend_string *const_SOCKOPT_GSSAPI_SERVICE_PRINCIPAL_NAMETYPE_name = zend_string_init_interned("SOCKOPT_GSSAPI_SERVICE_PRINCIPAL_NAMETYPE", sizeof("SOCKOPT_GSSAPI_SERVICE_PRINCIPAL_NAMETYPE") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_GSSAPI_SERVICE_PRINCIPAL_NAMETYPE_name);
#endif
	...
	zend_string *const_SOCKOPT_BINDTODEVICE_name = zend_string_init_interned("SOCKOPT_BINDTODEVICE", sizeof("SOCKOPT_BINDTODEVICE") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_BINDTODEVICE_name);
#endif
	...
	zend_string *const_SOCKOPT_HEARTBEAT_IVL_name = zend_string_init_interned("SOCKOPT_HEARTBEAT_IVL", sizeof("SOCKOPT_HEARTBEAT_IVL") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_HEARTBEAT_IVL_name);
#endif
#if ZMQ_VERSION_MAJOR == 4 && ZMQ_VERSION_MINOR >= 2

	zval const_SOCKOPT_HEARTBEAT_TTL_value;
	ZVAL_LONG(&const_SOCKOPT_HEARTBEAT_TTL_value, ZMQ_HEARTBEAT_TTL);
	zend_string *const_SOCKOPT_HEARTBEAT_TTL_name = zend_string_init_interned("SOCKOPT_HEARTBEAT_TTL", sizeof("SOCKOPT_HEARTBEAT_TTL") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_HEARTBEAT_TTL_name);
#endif
#if ZMQ_VERSION_MAJOR == 4 && ZMQ_VERSION_MINOR >= 2

	zval const_SOCKOPT_HEARTBEAT_TIMEOUT_value;
	ZVAL_LONG(&const_SOCKOPT_HEARTBEAT_TIMEOUT_value, ZMQ_HEARTBEAT_TIMEOUT);
	zend_string *const_SOCKOPT_HEARTBEAT_TIMEOUT_name = zend_string_init_interned("SOCKOPT_HEARTBEAT_TIMEOUT", sizeof("SOCKOPT_HEARTBEAT_TIMEOUT") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_HEARTBEAT_TIMEOUT_name);
#endif
#if ZMQ_VERSION_MAJOR == 4 && ZMQ_VERSION_MINOR >= 2

	zval const_SOCKOPT_USE_FD_value;
	ZVAL_LONG(&const_SOCKOPT_USE_FD_value, ZMQ_USE_FD);
	zend_string *const_SOCKOPT_USE_FD_name = zend_string_init_interned("SOCKOPT_USE_FD", sizeof("SOCKOPT_USE_FD") - 1, 1);
	zend_declare_class_constant_ex(class_entry, const_SOCKOPT_USE_FD_name, &const_SOCKOPT_USE_FD_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release(const_SOCKOPT_USE_FD_name);
#endif
#if ZMQ_VERSION_MAJOR == 4 && ZMQ_VERSION_MINOR >= 2

	zval const_SOCKOPT_XPUB_MANUAL_value;
	ZVAL_LONG(&const_SOCKOPT_XPUB_MANUAL_value, ZMQ_XPUB_MANUAL);
	zend_string *const_SOCKOPT_XPUB_MANUAL_name = zend_string_init_interned("SOCKOPT_XPUB_MANUAL", sizeof("SOCKOPT_XPUB_MANUAL") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_XPUB_MANUAL_name);
#endif
#if ZMQ_VERSION_MAJOR == 4 && ZMQ_VERSION_MINOR >= 2

	zval const_SOCKOPT_XPUB_WELCOME_MSG_value;
	ZVAL_LONG(&const_SOCKOPT_XPUB_WELCOME_MSG_value, ZMQ_XPUB_WELCOME_MSG);
	zend_string *const_SOCKOPT_XPUB_WELCOME_MSG_name = zend_string_init_interned("SOCKOPT_XPUB_WELCOME_MSG", sizeof("SOCKOPT_XPUB_WELCOME_MSG") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_XPUB_WELCOME_MSG_name);
#endif
#if ZMQ_VERSION_MAJOR == 4 && ZMQ_VERSION_MINOR >= 2

	zval const_SOCKOPT_STREAM_NOTIFY_value;
	ZVAL_LONG(&const_SOCKOPT_STREAM_NOTIFY_value, ZMQ_STREAM_NOTIFY);
	zend_string *const_SOCKOPT_STREAM_NOTIFY_name = zend_string_init_interned("SOCKOPT_STREAM_NOTIFY", sizeof("SOCKOPT_STREAM_NOTIFY") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_STREAM_NOTIFY_name);
#endif
#if ZMQ_VERSION_MAJOR == 4 && ZMQ_VERSION_MINOR >= 2

	zval const_SOCKOPT_INVERT_MATCHING_value;
	ZVAL_LONG(&const_SOCKOPT_INVERT_MATCHING_value, ZMQ_INVERT_MATCHING);
	zend_string *const_SOCKOPT_INVERT_MATCHING_name = zend_string_init_interned("SOCKOPT_INVERT_MATCHING", sizeof("SOCKOPT_INVERT_MATCHING") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_INVERT_MATCHING_name);
#endif
#if ZMQ_VERSION_MAJOR == 4 && ZMQ_VERSION_MINOR >= 2

	zval const_SOCKOPT_XPUB_VERBOSER_value;
	ZVAL_LONG(&const_SOCKOPT_XPUB_VERBOSER_value, ZMQ_XPUB_VERBOSER);
	zend_string *const_SOCKOPT_XPUB_VERBOSER_name = zend_string_init_interned("SOCKOPT_XPUB_VERBOSER", sizeof("SOCKOPT_XPUB_VERBOSER") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_XPUB_VERBOSER_name);
#endif
#if ZMQ_VERSION_MAJOR == 4 && ZMQ_VERSION_MINOR >= 2

	zval const_SOCKOPT_CONNECT_TIMEOUT_value;
	ZVAL_LONG(&const_SOCKOPT_CONNECT_TIMEOUT_value, ZMQ_CONNECT_TIMEOUT);
	zend_string *const_SOCKOPT_CONNECT_TIMEOUT_name = zend_string_init_interned("SOCKOPT_CONNECT_TIMEOUT", sizeof("SOCKOPT_CONNECT_TIMEOUT") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_CONNECT_TIMEOUT_name);
#endif
#if ZMQ_VERSION_MAJOR == 4 && ZMQ_VERSION_MINOR >= 2

	zval const_SOCKOPT_TCP_MAXRT_value;
	ZVAL_LONG(&const_SOCKOPT_TCP_MAXRT_value, ZMQ_TCP_MAXRT);
	zend_string *const_SOCKOPT_TCP_MAXRT_name = zend_string_init_interned("SOCKOPT_TCP_MAXRT", sizeof("SOCKOPT_TCP_MAXRT") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_TCP_MAXRT_name);
#endif
#if ZMQ_VERSION_MAJOR == 4 && ZMQ_VERSION_MINOR >= 2

	zval const_SOCKOPT_MULTICAST_MAXTPDU_value;
	ZVAL_LONG(&const_SOCKOPT_MULTICAST_MAXTPDU_value, ZMQ_MULTICAST_MAXTPDU);
	zend_string *const_SOCKOPT_MULTICAST_MAXTPDU_name = zend_string_init_interned("SOCKOPT_MULTICAST_MAXTPDU", sizeof("SOCKOPT_MULTICAST_MAXTPDU") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_MULTICAST_MAXTPDU_name);
#endif
#if ZMQ_VERSION_MAJOR == 4 && ZMQ_VERSION_MINOR >= 2

	zval const_SOCKOPT_VMCI_BUFFER_SIZE_value;
	ZVAL_LONG(&const_SOCKOPT_VMCI_BUFFER_SIZE_value, ZMQ_VMCI_BUFFER_SIZE);
	zend_string *const_SOCKOPT_VMCI_BUFFER_SIZE_name = zend_string_init_interned("SOCKOPT_VMCI_BUFFER_SIZE", sizeof("SOCKOPT_VMCI_BUFFER_SIZE") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_VMCI_BUFFER_SIZE_name);
#endif
#if ZMQ_VERSION_MAJOR == 4 && ZMQ_VERSION_MINOR >= 2

	zval const_SOCKOPT_VMCI_BUFFER_MIN_SIZE_value;
	ZVAL_LONG(&const_SOCKOPT_VMCI_BUFFER_MIN_SIZE_value, ZMQ_VMCI_BUFFER_MIN_SIZE);
	zend_string *const_SOCKOPT_VMCI_BUFFER_MIN_SIZE_name = zend_string_init_interned("SOCKOPT_VMCI_BUFFER_MIN_SIZE", sizeof("SOCKOPT_VMCI_BUFFER_MIN_SIZE") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_VMCI_BUFFER_MIN_SIZE_name);
#endif
#if ZMQ_VERSION_MAJOR == 4 && ZMQ_VERSION_MINOR >= 2

	zval const_SOCKOPT_VMCI_BUFFER_MAX_SIZE_value;
	ZVAL_LONG(&const_SOCKOPT_VMCI_BUFFER_MAX_SIZE_value, ZMQ_VMCI_BUFFER_MAX_SIZE);
	zend_string *const_SOCKOPT_VMCI_BUFFER_MAX_SIZE_name = zend_string_init_interned("SOCKOPT_VMCI_BUFFER_MAX_SIZE", sizeof("SOCKOPT_VMCI_BUFFER_MAX_SIZE") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_VMCI_BUFFER_MAX_SIZE_name);
#endif
#if ZMQ_VERSION_MAJOR == 4 && ZMQ_VERSION_MINOR >= 2

	zval const_SOCKOPT_VMCI_CONNECT_TIMEOUT_value;
	ZVAL_LONG(&const_SOCKOPT_VMCI_CONNECT_TIMEOUT_value, ZMQ_VMCI_CONNECT_TIMEOUT);
	zend_string *const_SOCKOPT_VMCI_CONNECT_TIMEOUT_name = zend_string_init_interned("SOCKOPT_VMCI_CONNECT_TIMEOUT", sizeof("SOCKOPT_VMCI_CONNECT_TIMEOUT") - 1, 1);
	...
	zend_string_release(const_ZMQ_ROUTER_HANDOVER_name);
#endif
#if ZMQ_VERSION_MAJOR == 4 && ZMQ_VERSION_MINOR >= 1

	zval const_SOCKOPT_CONNECT_RID_value;
	ZVAL_LONG(&const_SOCKOPT_CONNECT_RID_value, ZMQ_CONNECT_RID);
	zend_string *const_SOCKOPT_CONNECT_RID_name = zend_string_init_interned("SOCKOPT_CONNECT_RID", sizeof("SOCKOPT_CONNECT_RID") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_CONNECT_RID_name);
#endif
#if ZMQ_VERSION_MAJOR == 4 && ZMQ_VERSION_MINOR >= 1

	zval const_SOCKOPT_HANDSHAKE_IVL_value;
	ZVAL_LONG(&const_SOCKOPT_HANDSHAKE_IVL_value, ZMQ_HANDSHAKE_IVL);
	zend_string *const_SOCKOPT_HANDSHAKE_IVL_name = zend_string_init_interned("SOCKOPT_HANDSHAKE_IVL", sizeof("SOCKOPT_HANDSHAKE_IVL") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_HANDSHAKE_IVL_name);
#endif
#if ZMQ_VERSION_MAJOR == 4 && ZMQ_VERSION_MINOR >= 1

	zval const_SOCKOPT_SOCKS_PROXY_value;
	ZVAL_LONG(&const_SOCKOPT_SOCKS_PROXY_value, ZMQ_SOCKS_PROXY);
	zend_string *const_SOCKOPT_SOCKS_PROXY_name = zend_string_init_interned("SOCKOPT_SOCKS_PROXY", sizeof("SOCKOPT_SOCKS_PROXY") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_SOCKS_PROXY_name);
#endif
#if ZMQ_VERSION_MAJOR == 4 && ZMQ_VERSION_MINOR >= 1

	zval const_SOCKOPT_XPUB_NODROP_value;
	ZVAL_LONG(&const_SOCKOPT_XPUB_NODROP_value, ZMQ_XPUB_NODROP);
	zend_string *const_SOCKOPT_XPUB_NODROP_name = zend_string_init_interned("SOCKOPT_XPUB_NODROP", sizeof("SOCKOPT_XPUB_NODROP") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_XPUB_NODROP_name);
#endif
#if ZMQ_VERSION_MAJOR == 4

	zval const_SOCKOPT_ROUTER_MANDATORY_value;
	ZVAL_LONG(&const_SOCKOPT_ROUTER_MANDATORY_value, ZMQ_ROUTER_MANDATORY);
	zend_string *const_SOCKOPT_ROUTER_MANDATORY_name = zend_string_init_interned("SOCKOPT_ROUTER_MANDATORY", sizeof("SOCKOPT_ROUTER_MANDATORY") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_ROUTER_MANDATORY_name);
#endif
#if ZMQ_VERSION_MAJOR == 4

	zval const_SOCKOPT_PROBE_ROUTER_value;
	ZVAL_LONG(&const_SOCKOPT_PROBE_ROUTER_value, ZMQ_PROBE_ROUTER);
	zend_string *const_SOCKOPT_PROBE_ROUTER_name = zend_string_init_interned("SOCKOPT_PROBE_ROUTER", sizeof("SOCKOPT_PROBE_ROUTER") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_PROBE_ROUTER_name);
#endif
#if ZMQ_VERSION_MAJOR == 4

	zval const_SOCKOPT_REQ_RELAXED_value;
	ZVAL_LONG(&const_SOCKOPT_REQ_RELAXED_value, ZMQ_REQ_RELAXED);
	zend_string *const_SOCKOPT_REQ_RELAXED_name = zend_string_init_interned("SOCKOPT_REQ_RELAXED", sizeof("SOCKOPT_REQ_RELAXED") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_REQ_RELAXED_name);
#endif
#if ZMQ_VERSION_MAJOR == 4

	zval const_SOCKOPT_REQ_CORRELATE_value;
	ZVAL_LONG(&const_SOCKOPT_REQ_CORRELATE_value, ZMQ_REQ_CORRELATE);
	zend_string *const_SOCKOPT_REQ_CORRELATE_name = zend_string_init_interned("SOCKOPT_REQ_CORRELATE", sizeof("SOCKOPT_REQ_CORRELATE") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_REQ_CORRELATE_name);
#endif
#if ZMQ_VERSION_MAJOR == 4

	zval const_SOCKOPT_CONFLATE_value;
	ZVAL_LONG(&const_SOCKOPT_CONFLATE_value, ZMQ_CONFLATE);
	zend_string *const_SOCKOPT_CONFLATE_name = zend_string_init_interned("SOCKOPT_CONFLATE", sizeof("SOCKOPT_CONFLATE") - 1, 1);
	zend_declare_class_constant_ex(class_entry, const_SOCKOPT_CONFLATE_name, &const_SOCKOPT_CONFLATE_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release(const_SOCKOPT_CONFLATE_name);
#endif
#if ZMQ_VERSION_MAJOR == 4

	zval const_SOCKOPT_ZAP_DOMAIN_value;
	ZVAL_LONG(&const_SOCKOPT_ZAP_DOMAIN_value, ZMQ_ZAP_DOMAIN);
	zend_string *const_SOCKOPT_ZAP_DOMAIN_name = zend_string_init_interned("SOCKOPT_ZAP_DOMAIN", sizeof("SOCKOPT_ZAP_DOMAIN") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_ZAP_DOMAIN_name);
#endif
#if ZMQ_VERSION_MAJOR == 4

	zval const_SOCKOPT_MECHANISM_value;
	ZVAL_LONG(&const_SOCKOPT_MECHANISM_value, ZMQ_MECHANISM);
	zend_string *const_SOCKOPT_MECHANISM_name = zend_string_init_interned("SOCKOPT_MECHANISM", sizeof("SOCKOPT_MECHANISM") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_MECHANISM_name);
#endif
#if ZMQ_VERSION_MAJOR == 4

	zval const_SOCKOPT_PLAIN_SERVER_value;
	ZVAL_LONG(&const_SOCKOPT_PLAIN_SERVER_value, ZMQ_PLAIN_SERVER);
	zend_string *const_SOCKOPT_PLAIN_SERVER_name = zend_string_init_interned("SOCKOPT_PLAIN_SERVER", sizeof("SOCKOPT_PLAIN_SERVER") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_PLAIN_SERVER_name);
#endif
#if ZMQ_VERSION_MAJOR == 4

	zval const_SOCKOPT_PLAIN_USERNAME_value;
	ZVAL_LONG(&const_SOCKOPT_PLAIN_USERNAME_value, ZMQ_PLAIN_USERNAME);
	zend_string *const_SOCKOPT_PLAIN_USERNAME_name = zend_string_init_interned("SOCKOPT_PLAIN_USERNAME", sizeof("SOCKOPT_PLAIN_USERNAME") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_PLAIN_USERNAME_name);
#endif
#if ZMQ_VERSION_MAJOR == 4

	zval const_SOCKOPT_PLAIN_PASSWORD_value;
	ZVAL_LONG(&const_SOCKOPT_PLAIN_PASSWORD_value, ZMQ_PLAIN_PASSWORD);
	zend_string *const_SOCKOPT_PLAIN_PASSWORD_name = zend_string_init_interned("SOCKOPT_PLAIN_PASSWORD", sizeof("SOCKOPT_PLAIN_PASSWORD") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_PLAIN_PASSWORD_name);
#endif
	...
	zend_string *const_SOCKOPT_CURVE_SERVER_name = zend_string_init_interned("SOCKOPT_CURVE_SERVER", sizeof("SOCKOPT_CURVE_SERVER") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_CURVE_SERVER_name);
#endif
	...
	zend_string *const_SOCKOPT_CURVE_PUBLICKEY_name = zend_string_init_interned("SOCKOPT_CURVE_PUBLICKEY", sizeof("SOCKOPT_CURVE_PUBLICKEY") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_CURVE_PUBLICKEY_name);
#endif
	...
	zend_string *const_SOCKOPT_CURVE_SECRETKEY_name = zend_string_init_interned("SOCKOPT_CURVE_SECRETKEY", sizeof("SOCKOPT_CURVE_SECRETKEY") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_CURVE_SECRETKEY_name);
#endif
	...
	zend_string *const_SOCKOPT_CURVE_SERVERKEY_name = zend_string_init_interned("SOCKOPT_CURVE_SERVERKEY", sizeof("SOCKOPT_CURVE_SERVERKEY") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_CURVE_SERVERKEY_name);
#endif
	...
	zend_string *const_SOCKOPT_GSSAPI_SERVER_name = zend_string_init_interned("SOCKOPT_GSSAPI_SERVER", sizeof("SOCKOPT_GSSAPI_SERVER") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_GSSAPI_SERVER_name);
#endif
	...
	zend_string *const_SOCKOPT_GSSAPI_PLAINTEXT_name = zend_string_init_interned("SOCKOPT_GSSAPI_PLAINTEXT", sizeof("SOCKOPT_GSSAPI_PLAINTEXT") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_GSSAPI_PLAINTEXT_name);
#endif
	...
	zend_string *const_SOCKOPT_GSSAPI_PRINCIPAL_name = zend_string_init_interned("SOCKOPT_GSSAPI_PRINCIPAL", sizeof("SOCKOPT_GSSAPI_PRINCIPAL") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_GSSAPI_PRINCIPAL_name);
#endif
	...
	zend_string *const_SOCKOPT_GSSAPI_SERVICE_PRINCIPAL_name = zend_string_init_interned("SOCKOPT_GSSAPI_SERVICE_PRINCIPAL", sizeof("SOCKOPT_GSSAPI_SERVICE_PRINCIPAL") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_GSSAPI_SERVICE_PRINCIPAL_name);
#endif
#if ZMQ_VERSION_MAJOR == 4

	zval const_SOCKOPT_IPV6_value;
	ZVAL_LONG(&const_SOCKOPT_IPV6_value, ZMQ_IPV6);
	zend_string *const_SOCKOPT_IPV6_name = zend_string_init_interned("SOCKOPT_IPV6", sizeof("SOCKOPT_IPV6") - 1, 1);
	zend_declare_class_constant_ex(class_entry, const_SOCKOPT_IPV6_name, &const_SOCKOPT_IPV6_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release(const_SOCKOPT_IPV6_name);
#endif
#if ZMQ_VERSION_MAJOR == 4

	zval const_SOCKOPT_IMMEDIATE_value;
	ZVAL_LONG(&const_SOCKOPT_IMMEDIATE_value, ZMQ_IMMEDIATE);
	zend_string *const_SOCKOPT_IMMEDIATE_name = zend_string_init_interned("SOCKOPT_IMMEDIATE", sizeof("SOCKOPT_IMMEDIATE") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_MAXMSGSIZE_name);

	zval const_SOCKOPT_MULTICAST_HOPS_value;
	ZVAL_LONG(&const_SOCKOPT_MULTICAST_HOPS_value, ZMQ_MULTICAST_HOPS);
	zend_string *const_SOCKOPT_MULTICAST_HOPS_name = zend_string_init_interned("SOCKOPT_MULTICAST_HOPS", sizeof("SOCKOPT_MULTICAST_HOPS") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_MULTICAST_HOPS_name);

	zval const_SOCKOPT_XPUB_VERBOSE_value;
	ZVAL_LONG(&const_SOCKOPT_XPUB_VERBOSE_value, ZMQ_XPUB_VERBOSE);
	zend_string *const_SOCKOPT_XPUB_VERBOSE_name = zend_string_init_interned("SOCKOPT_XPUB_VERBOSE", sizeof("SOCKOPT_XPUB_VERBOSE") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_XPUB_VERBOSE_name);

	zval const_SOCKOPT_TCP_KEEPALIVE_value;
	ZVAL_LONG(&const_SOCKOPT_TCP_KEEPALIVE_value, ZMQ_TCP_KEEPALIVE);
	zend_string *const_SOCKOPT_TCP_KEEPALIVE_name = zend_string_init_interned("SOCKOPT_TCP_KEEPALIVE", sizeof("SOCKOPT_TCP_KEEPALIVE") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_TCP_KEEPALIVE_name);

	zval const_SOCKOPT_TCP_KEEPALIVE_IDLE_value;
	ZVAL_LONG(&const_SOCKOPT_TCP_KEEPALIVE_IDLE_value, ZMQ_TCP_KEEPALIVE_IDLE);
	zend_string *const_SOCKOPT_TCP_KEEPALIVE_IDLE_name = zend_string_init_interned("SOCKOPT_TCP_KEEPALIVE_IDLE", sizeof("SOCKOPT_TCP_KEEPALIVE_IDLE") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_TCP_KEEPALIVE_IDLE_name);

	zval const_SOCKOPT_TCP_KEEPALIVE_CNT_value;
	ZVAL_LONG(&const_SOCKOPT_TCP_KEEPALIVE_CNT_value, ZMQ_TCP_KEEPALIVE_CNT);
	zend_string *const_SOCKOPT_TCP_KEEPALIVE_CNT_name = zend_string_init_interned("SOCKOPT_TCP_KEEPALIVE_CNT", sizeof("SOCKOPT_TCP_KEEPALIVE_CNT") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_TCP_KEEPALIVE_CNT_name);

	zval const_SOCKOPT_TCP_KEEPALIVE_INTVL_value;
	ZVAL_LONG(&const_SOCKOPT_TCP_KEEPALIVE_INTVL_value, ZMQ_TCP_KEEPALIVE_INTVL);
	zend_string *const_SOCKOPT_TCP_KEEPALIVE_INTVL_name = zend_string_init_interned("SOCKOPT_TCP_KEEPALIVE_INTVL", sizeof("SOCKOPT_TCP_KEEPALIVE_INTVL") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_TCP_KEEPALIVE_INTVL_name);

	zval const_SOCKOPT_TCP_ACCEPT_FILTER_value;
	ZVAL_LONG(&const_SOCKOPT_TCP_ACCEPT_FILTER_value, ZMQ_TCP_ACCEPT_FILTER);
	zend_string *const_SOCKOPT_TCP_ACCEPT_FILTER_name = zend_string_init_interned("SOCKOPT_TCP_ACCEPT_FILTER", sizeof("SOCKOPT_TCP_ACCEPT_FILTER") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_TCP_ACCEPT_FILTER_name);

	zval const_SOCKOPT_LAST_ENDPOINT_value;
	ZVAL_LONG(&const_SOCKOPT_LAST_ENDPOINT_value, ZMQ_LAST_ENDPOINT);
	zend_string *const_SOCKOPT_LAST_ENDPOINT_name = zend_string_init_interned("SOCKOPT_LAST_ENDPOINT", sizeof("SOCKOPT_LAST_ENDPOINT") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_LAST_ENDPOINT_name);

	zval const_SOCKOPT_ROUTER_RAW_value;
	ZVAL_LONG(&const_SOCKOPT_ROUTER_RAW_value, ZMQ_ROUTER_RAW);
	zend_string *const_SOCKOPT_ROUTER_RAW_name = zend_string_init_interned("SOCKOPT_ROUTER_RAW", sizeof("SOCKOPT_ROUTER_RAW") - 1, 1);
	zend_class_constant *const_SOCKOPT_ROUTER_RAW = zend_declare_class_constant_ex(class_entry, const_SOCKOPT_ROUTER_RAW_name, &const_SOCKOPT_ROUTER_RAW_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release(const_SOCKOPT_ROUTER_RAW_name);

	zval const_SOCKOPT_IPV4ONLY_value;
	ZVAL_LONG(&const_SOCKOPT_IPV4ONLY_value, ZMQ_IPV4ONLY);
	zend_string *const_SOCKOPT_IPV4ONLY_name = zend_string_init_interned("SOCKOPT_IPV4ONLY", sizeof("SOCKOPT_IPV4ONLY") - 1, 1);
	zend_class_constant *const_SOCKOPT_IPV4ONLY = zend_declare_class_constant_ex(class_entry, const_SOCKOPT_IPV4ONLY_name, &const_SOCKOPT_IPV4ONLY_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release(const_SOCKOPT_IPV4ONLY_name);
	...
	zend_string *const_SOCKOPT_DELAY_ATTACH_ON_CONNECT_name = zend_string_init_interned("SOCKOPT_DELAY_ATTACH_ON_CONNECT", sizeof("SOCKOPT_DELAY_ATTACH_ON_CONNECT") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_RECONNECT_IVL_name);

	zval const_SOCKOPT_RECONNECT_IVL_MAX_value;
	ZVAL_LONG(&const_SOCKOPT_RECONNECT_IVL_MAX_value, ZMQ_RECONNECT_IVL_MAX);
	zend_string *const_SOCKOPT_RECONNECT_IVL_MAX_name = zend_string_init_interned("SOCKOPT_RECONNECT_IVL_MAX", sizeof("SOCKOPT_RECONNECT_IVL_MAX") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_RECONNECT_IVL_MAX_name);

	zval const_SOCKOPT_BACKLOG_value;
	ZVAL_LONG(&const_SOCKOPT_BACKLOG_value, ZMQ_BACKLOG);
	zend_string *const_SOCKOPT_BACKLOG_name = zend_string_init_interned("SOCKOPT_BACKLOG", sizeof("SOCKOPT_BACKLOG") - 1, 1);
	zend_declare_class_constant_ex(class_entry, const_SOCKOPT_BACKLOG_name, &const_SOCKOPT_BACKLOG_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release(const_SOCKOPT_BACKLOG_name);

	zval const_SOCKOPT_SUBSCRIBE_value;
	ZVAL_LONG(&const_SOCKOPT_SUBSCRIBE_value, ZMQ_SUBSCRIBE);
	zend_string *const_SOCKOPT_SUBSCRIBE_name = zend_string_init_interned("SOCKOPT_SUBSCRIBE", sizeof("SOCKOPT_SUBSCRIBE") - 1, 1);
	...
	zend_string_release(const_SOCKOPT_SUBSCRIBE_name);

	zval const_SOCKOPT_UNSUBSCRIBE_value;
	ZVAL_LONG(&const_SOCKOPT_UNSUBSCRIBE_value, ZMQ_UNSUBSCRIBE);
	zend_string *const_SOCKOPT_UNSUBSCRIBE_name = zend_string_init_interned("SOCKOPT_UNSUBSCRIBE", sizeof("SOCKOPT_UNSUBSCRIBE") - 1, 1);
	...
	zend_string_release(const_EVENT_CONNECT_DELAYED_name);

	zval const_EVENT_CONNECT_RETRIED_value;
	ZVAL_LONG(&const_EVENT_CONNECT_RETRIED_value, ZMQ_EVENT_CONNECT_RETRIED);
	zend_string *const_EVENT_CONNECT_RETRIED_name = zend_string_init_interned("EVENT_CONNECT_RETRIED", sizeof("EVENT_CONNECT_RETRIED") - 1, 1);
	...
	zend_string_release(const_EVENT_CONNECT_RETRIED_name);

	zval const_EVENT_LISTENING_value;
	ZVAL_LONG(&const_EVENT_LISTENING_value, ZMQ_EVENT_LISTENING);
	zend_string *const_EVENT_LISTENING_name = zend_string_init_interned("EVENT_LISTENING", sizeof("EVENT_LISTENING") - 1, 1);
	zend_declare_class_constant_ex(class_entry, const_EVENT_LISTENING_name, &const_EVENT_LISTENING_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release(const_EVENT_LISTENING_name);

	zval const_EVENT_BIND_FAILED_value;
	ZVAL_LONG(&const_EVENT_BIND_FAILED_value, ZMQ_EVENT_BIND_FAILED);
	zend_string *const_EVENT_BIND_FAILED_name = zend_string_init_interned("EVENT_BIND_FAILED", sizeof("EVENT_BIND_FAILED") - 1, 1);
	...
	zend_string_release(const_EVENT_BIND_FAILED_name);

	zval const_EVENT_ACCEPTED_value;
	ZVAL_LONG(&const_EVENT_ACCEPTED_value, ZMQ_EVENT_ACCEPTED);
	zend_string *const_EVENT_ACCEPTED_name = zend_string_init_interned("EVENT_ACCEPTED", sizeof("EVENT_ACCEPTED") - 1, 1);
	zend_declare_class_constant_ex(class_entry, const_EVENT_ACCEPTED_name, &const_EVENT_ACCEPTED_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release(const_EVENT_ACCEPTED_name);

	zval const_EVENT_ACCEPT_FAILED_value;
	ZVAL_LONG(&const_EVENT_ACCEPT_FAILED_value, ZMQ_EVENT_ACCEPT_FAILED);
	zend_string *const_EVENT_ACCEPT_FAILED_name = zend_string_init_interned("EVENT_ACCEPT_FAILED", sizeof("EVENT_ACCEPT_FAILED") - 1, 1);
	...
	zend_string_release(const_EVENT_ACCEPT_FAILED_name);

	zval const_EVENT_CLOSED_value;
	ZVAL_LONG(&const_EVENT_CLOSED_value, ZMQ_EVENT_CLOSED);
	zend_string *const_EVENT_CLOSED_name = zend_string_init_interned("EVENT_CLOSED", sizeof("EVENT_CLOSED") - 1, 1);
	zend_declare_class_constant_ex(class_entry, const_EVENT_CLOSED_name, &const_EVENT_CLOSED_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release(const_EVENT_CLOSED_name);

	zval const_EVENT_CLOSE_FAILED_value;
	ZVAL_LONG(&const_EVENT_CLOSE_FAILED_value, ZMQ_EVENT_CLOSE_FAILED);
	zend_string *const_EVENT_CLOSE_FAILED_name = zend_string_init_interned("EVENT_CLOSE_FAILED", sizeof("EVENT_CLOSE_FAILED") - 1, 1);
	...
	zend_string_release(const_EVENT_CLOSE_FAILED_name);

	zval const_EVENT_DISCONNECTED_value;
	ZVAL_LONG(&const_EVENT_DISCONNECTED_value, ZMQ_EVENT_DISCONNECTED);
	zend_string *const_EVENT_DISCONNECTED_name = zend_string_init_interned("EVENT_DISCONNECTED", sizeof("EVENT_DISCONNECTED") - 1, 1);
	...
	zend_string_release(const_EVENT_DISCONNECTED_name);

	zval const_EVENT_MONITOR_STOPPED_value;
	ZVAL_LONG(&const_EVENT_MONITOR_STOPPED_value, ZMQ_EVENT_MONITOR_STOPPED);
	zend_string *const_EVENT_MONITOR_STOPPED_name = zend_string_init_interned("EVENT_MONITOR_STOPPED", sizeof("EVENT_MONITOR_STOPPED") - 1, 1);
	...
	zend_string_release(const_EVENT_MONITOR_STOPPED_name);

	zval const_EVENT_ALL_value;
	ZVAL_LONG(&const_EVENT_ALL_value, ZMQ_EVENT_ALL);
	zend_string *const_EVENT_ALL_name = zend_string_init_interned("EVENT_ALL", sizeof("EVENT_ALL") - 1, 1);
	zend_declare_class_constant_ex(class_entry, const_EVENT_ALL_name, &const_EVENT_ALL_value, ZEND_ACC_PUBLIC, NULL);
	zend_string_release(const_EVENT_ALL_name);


	zend_string *attribute_name_Deprecated_const_SOCKOPT_ROUTER_RAW_0 = zend_string_init_interned("Deprecated", sizeof("Deprecated") - 1, 1);
	...
	zend_string_release(attribute_name_Deprecated_const_SOCKOPT_ROUTER_RAW_0);
	zval attribute_Deprecated_const_SOCKOPT_ROUTER_RAW_0_arg0;
	zend_string *attribute_Deprecated_const_SOCKOPT_ROUTER_RAW_0_arg0_str = zend_string_init("1.0", strlen("1.0"), 1);
	ZVAL_STR(&attribute_Deprecated_const_SOCKOPT_ROUTER_RAW_0_arg0, attribute_Deprecated_const_SOCKOPT_ROUTER_RAW_0_arg0_str);
	ZVAL_COPY_VALUE(&attribute_Deprecated_const_SOCKOPT_ROUTER_RAW_0->args[0].value, &attribute_Deprecated_const_SOCKOPT_ROUTER_RAW_0_arg0);
	attribute_Deprecated_const_SOCKOPT_ROUTER_RAW_0->args[0].name = zend_string_init("since", sizeof("since") - 1, 1);
	zval attribute_Deprecated_const_SOCKOPT_ROUTER_RAW_0_arg1;
	...
	ZVAL_STR(&attribute_Deprecated_const_SOCKOPT_ROUTER_RAW_0_arg1, attribute_Deprecated_const_SOCKOPT_ROUTER_RAW_0_arg1_str);
	ZVAL_COPY_VALUE(&attribute_Deprecated_const_SOCKOPT_ROUTER_RAW_0->args[1].value, &attribute_Deprecated_const_SOCKOPT_ROUTER_RAW_0_arg1);
	attribute_Deprecated_const_SOCKOPT_ROUTER_RAW_0->args[1].name = zend_string_init("message", sizeof("message") - 1, 1);

	zend_string *attribute_name_Deprecated_const_SOCKOPT_IPV4ONLY_0 = zend_string_init_interned("Deprecated", sizeof("Deprecated") - 1, 1);
	...
	zend_string_release(attribute_name_Deprecated_const_SOCKOPT_IPV4ONLY_0);
	zval attribute_Deprecated_const_SOCKOPT_IPV4ONLY_0_arg0;
	zend_string *attribute_Deprecated_const_SOCKOPT_IPV4ONLY_0_arg0_str = zend_string_init("1.0", strlen("1.0"), 1);
	ZVAL_STR(&attribute_Deprecated_const_SOCKOPT_IPV4ONLY_0_arg0, attribute_Deprecated_const_SOCKOPT_IPV4ONLY_0_arg0_str);
	ZVAL_COPY_VALUE(&attribute_Deprecated_const_SOCKOPT_IPV4ONLY_0->args[0].value, &attribute_Deprecated_const_SOCKOPT_IPV4ONLY_0_arg0);
	attribute_Deprecated_const_SOCKOPT_IPV4ONLY_0->args[0].name = zend_string_init("since", sizeof("since") - 1, 1);
	zval attribute_Deprecated_const_SOCKOPT_IPV4ONLY_0_arg1;
	...
	ZVAL_STR(&attribute_Deprecated_const_SOCKOPT_IPV4ONLY_0_arg1, attribute_Deprecated_const_SOCKOPT_IPV4ONLY_0_arg1_str);
	ZVAL_COPY_VALUE(&attribute_Deprecated_const_SOCKOPT_IPV4ONLY_0->args[1].value, &attribute_Deprecated_const_SOCKOPT_IPV4ONLY_0_arg1);
	attribute_Deprecated_const_SOCKOPT_IPV4ONLY_0->args[1].name = zend_string_init("message", sizeof("message") - 1, 1);
...
static zend_class_entry *register_class_ZMQException(zend_class_entry *class_entry_Exception)
{
	...
	INIT_CLASS_ENTRY(ce, "ZMQException", class_ZMQException_methods);
...
static zend_class_entry *register_class_ZMQContextException(zend_class_entry *class_entry_ZMQException)
{
	...
	INIT_CLASS_ENTRY(ce, "ZMQContextException", class_ZMQContextException_methods);
...
static zend_class_entry *register_class_ZMQSocketException(zend_class_entry *class_entry_ZMQException)
{
	...
	INIT_CLASS_ENTRY(ce, "ZMQSocketException", class_ZMQSocketException_methods);
	class_entry = zend_register_internal_class_ex(&ce, class_entry_ZMQException);
...
static zend_class_entry *register_class_ZMQPollException(zend_class_entry *class_entry_ZMQException)
{
	...
	INIT_CLASS_ENTRY(ce, "ZMQPollException", class_ZMQPollException_methods);
	class_entry = zend_register_internal_class_ex(&ce, class_entry_ZMQException);
...
static zend_class_entry *register_class_ZMQDeviceException(zend_class_entry *class_entry_ZMQException)
{
	...
	INIT_CLASS_ENTRY(ce, "ZMQDeviceException", class_ZMQDeviceException_methods);
	class_entry = zend_register_internal_class_ex(&ce, class_entry_ZMQException);
